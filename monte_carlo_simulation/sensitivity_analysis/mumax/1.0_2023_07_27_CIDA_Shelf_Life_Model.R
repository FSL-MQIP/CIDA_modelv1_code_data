...
date <- Sys.Date()
date <- gsub("-", "_", date)
file_name_1 <- paste0("sensitivity_analysis/mumax/output/sa_mumax_threshold_", date,".csv")
file_name_2 <- paste0("sensitivity_analysis/mumax/output/sa_mumax_count_", date,".csv")
