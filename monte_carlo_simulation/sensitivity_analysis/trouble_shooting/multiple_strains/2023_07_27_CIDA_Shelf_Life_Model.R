...
write.csv(count_summary_by_day, file = "sensitivity_analysis/trouble_shooting/outputs/inc.strains_count_by_day.csv", row.names = FALSE)
write.csv(percent_packages_nmax, file = "sensitivity_analysis/trouble_shooting/outputs/inc.strains_percentage_of_packages_at_nmax.csv", row.names = FALSE)
write.csv(counts_summary_by_package, file = "sensitivity_analysis/trouble_shooting/outputs/inc.strains_total_count_by_package.csv", row.names = FALSE)
