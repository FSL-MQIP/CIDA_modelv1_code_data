...
s12_141 <- st_frequency$frequency[st_frequency$growth_isolates == "s12-0141"]
mod_s12_141 <- s12_141*1.0
mod_sum <- sum(st_frequency$frequency[st_frequency$growth_isolates != "s12-0141"])
st_frequency$mod_freq <- st_frequency$frequency + (st_frequency$frequency/mod_sum)*(s12_141 - mod_s12_141)
st_frequency$mod_freq[st_frequency$growth_isolates == "s12-0141"] <- mod_s12_141
