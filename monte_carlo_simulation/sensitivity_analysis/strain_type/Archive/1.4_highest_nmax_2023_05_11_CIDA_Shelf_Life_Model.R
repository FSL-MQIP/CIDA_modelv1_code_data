...
s12_132 <- st_frequency$frequency[st_frequency$cida_isolates == "s12-0132"]
mod_s12_132 <- s12_132*1.4
mod_sum <- sum(st_frequency$frequency[st_frequency$cida_isolates != "s12-0132"])
st_frequency$mod_freq <- st_frequency$frequency + (st_frequency$frequency/mod_sum)*(s12_132 - mod_s12_132)
st_frequency$mod_freq[st_frequency$cida_isolates == "s12-0132"] <- mod_s12_132
