...
date <- Sys.Date()
date <- gsub("-", "_", date)
file_name_1 <- paste0("sensitivity_analysis/strain_no/output/sa_strain_no_threshold_", date,".csv")
file_name_2 <- paste0("sensitivity_analysis/strain_no/output/sa_strain_no_count_", date,".csv")
