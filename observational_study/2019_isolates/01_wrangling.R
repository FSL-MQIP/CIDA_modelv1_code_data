...
##--------------------------Raw Data--------------------------------------------
blast <- read.csv("data/0919a_raw_blast_results.csv", header = TRUE)
metadata <- read.csv("data/FMT_isolates.csv", header = TRUE)
...
write.csv(fsl_previd, "data/0919a_isolates_fsl_previd.csv", row.names = FALSE)
