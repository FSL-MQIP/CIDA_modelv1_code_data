...
spinachmass <- read.csv("data/0919A_Sample_Mass.csv", header = TRUE) 
inprocess <- read.csv("data/PlateCountData_PilotSampling_InProcessSamples_Sept2019_101019.csv", header = TRUE)
shelflife <- read.csv("data/PlateCountData_PilotSampling_ShelfLifeSamples_Sept2019_102619.csv", header = TRUE)
...
write.csv(wrangled_counts, "data/0919a_microbial_counts.csv", row.names = FALSE)
