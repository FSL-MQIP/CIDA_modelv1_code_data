## ----------------------Title--------------------------------------------------
#   Overlay the strain and apc data and primary models for plotting (for the paper)

## ----------------------Description--------------------------------------------
#   Project: CIDA Spinach 

#  Script description: See script title. Describes purpose of the script
...
#Subsetting values predicted by the primary model
