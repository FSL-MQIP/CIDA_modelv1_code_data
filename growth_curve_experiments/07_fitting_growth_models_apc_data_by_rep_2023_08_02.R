##  ----------------------------Title-------------------------------------------
#   Fitting models to the apc growth data, with data from all three replicates 

##  --------------------------Description---------------------------------------
#   Project: CIDA Spinach 

#   Script description: Primary growth models, Baranyi (with and without lag), Buchanan (with and without lag) and Gompertz) will be fit to the apc growth data. 
#                       Approach 1: Not removing counts in the death phase
#                       Approach 2: Removing counts in the death phase

#This file is originally dated 2023_04_28
#It was edited on 2023_08_02, to calculate the AIC of the APC primary growth models and to change the maxiter for S12-0116 rep 2. No otehr changes were made
#The maxiter wad changed for S12-0116 2, to avoid the maxiter error
...
##  --------------------------Data----------------------------------------------
#Read in data 
strain_apc_data <- read.csv("data/wrangled/2023_04_28_apc_strain_averaged_wrangled_03.csv", header = TRUE)
param_estimates <- read.csv("outputs/parameters/initial_parameter_estimates_apc_by_rep2023_04_28.csv", header = TRUE)
...
#write.csv(final_model, paste("outputs/parameters/primary_model_parameters_apc_by_rep_", date, ".csv", sep = ""), row.names = FALSE)
#write.csv(param_ave, paste("outputs/parameters/primary_model_parameters_apc_averaged_", date, ".csv", sep = ""), row.names = FALSE)
