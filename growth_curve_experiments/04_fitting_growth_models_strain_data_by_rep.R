...
param_estimates <- read.csv("outputs/parameters/initial_parameter_estimates_strain_by_rep.csv", header = TRUE)
...
write.csv(gomp, "outputs/parameters/primary_model_parameters_strain_by_rep.csv", row.names = FALSE)

write.csv(param_ave, "outputs/parameters/primary_model_parameters_strain_averaged.csv", row.names = FALSE)
